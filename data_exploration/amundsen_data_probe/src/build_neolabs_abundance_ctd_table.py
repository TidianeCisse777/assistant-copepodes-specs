...
NEOLABS = ROOT / "Donnée Neolabs Taxon"
EXAMPLES = ROOT / "examples_tsv"
RAW = ROOT / "amundsen_data_probe" / "outputs" / "raw" / "neolabs_ctd"
REPORT = ROOT / "amundsen_data_probe" / "outputs" / "report_neolabs_abundance_ctd.md"

ABUNDANCE_PATH = NEOLABS / "IDEA Taxonomy Zooplankton Abundances Data May 26 2026.csv"
SAMPLE_METADATA_PATH = NEOLABS / "donne_sample.csv"
OUT = EXAMPLES / "neolabs_taxonomy_abundance_amundsen_ctd.tsv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build an agent-ready NeoLabs taxonomy abundance table enriched with Amundsen CTD context."
    )
